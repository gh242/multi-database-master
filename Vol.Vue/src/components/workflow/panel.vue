...
export default {
    ...
    mounted() {
        ...
        // this.$nextTick(() => {
        //     // 默認加载流程A的数据、在這裡可以根据具体的業務返回符合流程数据格式的数据即可
    ...
    methods: {
        ...
        jsPlumbInit() {
            this.jsPlumb.ready(() => {
                ...
                // 初始化节点
                this.loadEasyFlow()
                // 单点击了連接线, https://www.cnblogs.com/ysx215/p/7615677.html
