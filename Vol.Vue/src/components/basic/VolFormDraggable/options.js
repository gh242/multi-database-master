const components = [
    ...
    { id: 5, name: "单选", type: "radio", icon: "el-icon-aim", value: 0, data: [{ label: "0", value: "請設置数据源1" }, { label: "1", value: "請設置数据源2" }], key: "" },
    {
        id: 6,
        name: "多选",
        values: [],
        type: "checkbox",
        key: "",
        data: [{ label: "請設置数据源", value: "請設置数据源" }],
...
const tableOption = [
    ...
    {
        field: 'dataType', title: '显示類型', edit: { type: "select", keep: true }, width: 120, bind: {
            key: '', data: [
                { "key": "switch", "value": "单选" },
                { "key": "date", "value": "年月日" },
                { "key": "img", "value": "圖片" },
    ...
    {
        field: 'editType', title: '编辑類型', edit: { type: "select", keep: true, }, width: 120, bind: {
