 ...
 *業務請在@/extension/system/form/FormCollection.js此處编写
 -->
<template>
    <view-grid ref="grid"
               :columns="columns"
...
<script>
    ...
    export default defineComponent({
        setup() {
            ...
            const searchFormOptions = ref([[{"title":"标题","field":"Title","type":"like"},{"title":"提交人","field":"Creator","type":"like"},{"title":"提交時间","field":"CreateDate","type":"datetime"}]]);
            const columns = ref([{field:'FormCollectionId',title:'FormCollectionId',type:'guid',width:110,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'CreateDate',title:'提交時间',type:'datetime',width:145,align:'left',sort:true},
