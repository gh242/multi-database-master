 ...
 *業務請在@/extension/system/form/FormDesignOptions.js此處编写
 -->
<template>
    <view-grid ref="grid"
               :columns="columns"
...
<script>
    ...
    export default defineComponent({
        setup() {
            ...
            const searchFormOptions = ref([[{"title":"表单名称","field":"Title","type":"like"},{"title":"创建時间","field":"CreateDate","type":"datetime"},{"title":"修改時间","field":"ModifyDate","type":"datetime"}]]);
            const columns = ref([{field:'FormId',title:'FormId',type:'guid',width:110,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'DaraggeOptions',title:'設计器配置',type:'string',width:140,align:'left'},
