 ...
 *業務請在@/extension/system/quartz/Sys_QuartzLog.js此處编写
 -->
<template>
    <view-grid ref="grid"
               :columns="columns"
...
<script>
    ...
    export default defineComponent({
        setup() {
            ...
            const searchFormOptions = ref([[{"title":"任务名称","field":"TaskName","type":"like"},{"title":"耗時(秒)","field":"ElapsedTime","type":"range"},{"title":"开始時间","field":"StratDate","type":"datetime"},{"dataKey":"enable","data":[],"title":"是否成功","field":"Result","type":"select"}]]);
            const columns = ref([{field:'LogId',title:'LogId',type:'guid',width:110,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'StratDate',title:'开始時间',type:'datetime',width:150,align:'left',sort:true},
                       {field:'EndDate',title:'結束時间',type:'datetime',width:150,align:'left',sort:true},
