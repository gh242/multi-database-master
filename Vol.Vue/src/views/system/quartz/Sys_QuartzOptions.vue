 ...
 *業務請在@/extension/system/quartz/Sys_QuartzOptions.js此處编写
 -->
<template>
    <view-grid ref="grid"
               :columns="columns"
        ...
        setup() {
            ...
            const editFormOptions = ref([[{"title":"任务名称","required":true,"field":"TaskName"},
                              ...
                              [{"title":"创建人","field":"Creator","disabled":true},
                               {"title":"创建時间","field":"CreateDate","disabled":true}]]);
            const searchFormFields = ref({"TaskName":"","LastRunTime":"","CreateDate":"","ModifyDate":""});
            const searchFormOptions = ref([[{"title":"任务名称","field":"TaskName","type":"like"},{"title":"最后執行時间","field":"LastRunTime","type":"datetime"},{"title":"创建時间","field":"CreateDate","type":"datetime"},{"title":"修改時间","field":"ModifyDate","type":"datetime"}]]);
            const columns = ref([{field:'Id',title:'Id',type:'guid',width:110,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'GroupName',title:'任务分組',type:'string',width:100,require:true,align:'left'},
                       {field:'Method',title:'請求方式',type:'string',bind:{ key:'請求方式',data:[]},width:110,align:'left'},
                       {field:'TimeOut',title:'超時時间(秒)',type:'int',width:80,hidden:true,align:'left'},
                       ...
                       {field:'LastRunTime',title:'最后執行時间',type:'datetime',width:150,align:'left',sort:true},
                       ...
                       {field:'CreateDate',title:'创建時间',type:'datetime',width:150,hidden:true,readonly:true,align:'left',sort:true},
                       {field:'ModifyID',title:'ModifyID',type:'int',width:80,hidden:true,align:'left'},
                       {field:'Modifier',title:'Modifier',type:'string',width:130,hidden:true,align:'left'},
                       {field:'ModifyDate',title:'修改時间',type:'datetime',width:110,hidden:true,align:'left',sort:true}]);
            const detail = ref({
                cnName: "#detailCnName",
                table: "#detailTable",
                columns: [],
