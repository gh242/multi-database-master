 ...
 *業務請在@/extension/system/Sys_Dictionary.js此處编写
 -->
<template>
    <view-grid ref="grid"
               :columns="columns"
    ...
    export default defineComponent({
        setup() {
            ...
            const editFormOptions = ref([[{"title":"字典编号","required":true,"field":"DicNo"},
                              ...
                              [{"dataKey":"enable","data":[],"title":"所在數據庫","field":"DBServer","type":"select"},
            ...
            const searchFormOptions = ref([[{"title":"字典编号","field":"DicNo"},{"title":"字典名称","field":"DicName","type":"text"},{"title":"父级ID","field":"ParentId","type":"number"}],[{"dataKey":"enable","data":[],"title":"是否启用","field":"Enable","type":"select"},{"title":"创建時间","field":"CreateDate","type":"datetime"},{"title":"修改時间","field":"ModifyDate","type":"datetime"}]]);
            const columns = ref([{field:'Dic_ID',title:'字典ID',type:'int',width:90,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'ParentId',title:'父级ID',type:'int',width:90,hidden:true,require:true,align:'left'},
                       ...
                       {field:'DBServer',title:'所在數據庫',type:'string',bind:{ key:'enable',data:[]},width:130,align:'left'},
                       {field:'OrderNo',title:'排序号',type:'int',width:90,align:'left'},
                       {field:'Remark',title:'备注',type:'string',width:90,hidden:true,align:'left'},
                       {field:'Enable',title:'是否启用',type:'byte',bind:{ key:'enable',data:[]},width:90,hidden:true,require:true,align:'left'},
                       ...
                       {field:'CreateDate',title:'创建時间',type:'datetime',width:150,readonly:true,align:'left',sort:true},
                       ...
                       {field:'ModifyDate',title:'修改時间',type:'datetime',width:150,readonly:true,align:'left',sort:true}]);
            const detail = ref({
                cnName: "字典明细",
                ...
                columns: [{field:'DicList_ID',title:'DicList_ID',type:'int',width:90,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'CreateDate',title:'创建時间',type:'datetime',width:90,readonly:true,align:'left',sort:true},
                       {field:'ModifyID',title:'ModifyID',type:'int',width:90,hidden:true,align:'left'},
                       {field:'Modifier',title:'修改人',type:'string',width:130,align:'left'},
                       {field:'ModifyDate',title:'修改時间',type:'datetime',width:90,align:'left',sort:true}],
                sortName: "DicList_ID",
                key: "DicList_ID"
            });
            return {
