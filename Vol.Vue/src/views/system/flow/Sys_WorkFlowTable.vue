 ...
 *業務請在@/extension/system/flow/Sys_WorkFlowTable.js此處编写
 -->
<template>
    <view-grid ref="grid"
               :columns="columns"
...
<script>
    ...
    export default defineComponent({
        setup() {
            ...
            const searchFormOptions = ref([[{"dataKey":"audit","data":[],"title":"审批状态","field":"AuditStatus","type":"select"},{"title":"流程名称","field":"WorkName","type":"like"},{"title":"業務名称","field":"WorkTableName","type":"like"},{"title":"创建時间","field":"CreateDate","type":"datetime"}]]);
            const columns = ref([{field:'WorkFlowTable_Id',title:'WorkFlowTable_Id',type:'guid',width:110,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'WorkTableName',title:'業務名称',type:'string',width:120,align:'left'},
                       {field:'CurrentStepId',title:'當前审核节点ID',type:'string',width:110,align:'left'},
                       {field:'StepName',title:'當前审核节点名称',type:'string',width:120,align:'left'},
            ...
            const detail = ref({
                ...
                columns: [{field:'Sys_WorkFlowTableStep_Id',title:'Sys_WorkFlowTableStep_Id',type:'guid',width:110,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'StepType',title:'审批類型',type:'int',width:110,align:'left'},
                       {field:'StepValue',title:'节点類型(1=按用戶审批,2=按角色审批)',type:'string',width:110,align:'left'},
                       ...
                       {field:'AuditDate',title:'审核時间',type:'datetime',width:150,align:'left',sort:true},
                       {field:'StepAttrType',title:'节点屬性(start、node、end))',type:'string',width:110,align:'left'},
