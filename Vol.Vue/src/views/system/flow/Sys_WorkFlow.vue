 ...
 *業務請在@/extension/system/flow/Sys_WorkFlow.js此處编写
 -->
<template>
    <view-grid ref="grid"
               :columns="columns"
...
<script>
    ...
    export default defineComponent({
        setup() {
            ...
            const searchFormOptions = ref([[{"title":"流程名称","field":"WorkName"},{"title":"表名","field":"WorkTable"},{"dataKey":"enable","data":[],"title":"审核中数据是否可以编辑","field":"AuditingEdit","type":"select"},{"title":"创建時间","field":"CreateDate","type":"datetime"}]]);
            const columns = ref([{field:'WorkFlow_Id',title:'WorkFlow_Id',type:'guid',width:110,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'CreateDate',title:'创建時间',type:'datetime',width:150,align:'left',sort:true},
                       {field:'ModifyID',title:'ModifyID',type:'int',width:80,hidden:true,align:'left'},
                       {field:'Modifier',title:'修改人',type:'string',width:100,hidden:true,align:'left'},
                       {field:'ModifyDate',title:'修改時间',type:'datetime',width:160,align:'left',sort:true}]);
            const detail = ref({
                cnName: "审批节点配置",
                ...
                columns: [{field:'WorkStepFlow_Id',title:'WorkStepFlow_Id',type:'guid',width:110,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'StepType',title:'节点類型(1=按用戶审批,2=按角色审批)',type:'int',width:110,align:'left'},
                       {field:'StepValue',title:'审批用戶id或角色id',type:'string',width:110,align:'left'},
                       {field:'Remark',title:'备注',type:'string',width:220,align:'left'},
                       {field:'OrderId',title:'审批顺序',type:'int',width:80,align:'left'},
                       {field:'CreateDate',title:'创建時间',type:'datetime',width:110,align:'left',sort:true},
                       {field:'CreateID',title:'CreateID',type:'int',width:80,hidden:true,align:'left'},
                       ...
                       {field:'ModifyDate',title:'修改時间',type:'datetime',width:110,align:'left',sort:true},
                       {field:'ModifyID',title:'ModifyID',type:'int',width:80,hidden:true,align:'left'},
                       ...
                       {field:'AuditRefuse',title:'审核未通過(返回上一节点,流程重新开始,流程結束)',type:'int',width:80,hidden:true,align:'left'},
                       {field:'AuditBack',title:'驳回(返回上一节点,流程重新开始,流程結束)',type:'int',width:80,hidden:true,align:'left'},
                       ...
                       {field:'StepAttrType',title:'节点屬性(start、node、end))',type:'string',width:110,hidden:true,align:'left'},
