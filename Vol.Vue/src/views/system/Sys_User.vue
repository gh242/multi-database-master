 ...
 *業務請在@/extension/system/Sys_User.js此處编写
 -->
<template>
    <view-grid ref="grid"
               :columns="columns"
    ...
    export default defineComponent({
        setup() {
            ...
            const editFormOptions = ref([[{"title":"帐号","required":true,"field":"UserName","disabled":true}],
                              ...
                              [{"dataKey":"組织机构","data":[],"title":"組织构架","field":"DeptIds","colSize":12,"type":"treeSelect"}],
            ...
            const searchFormOptions = ref([[{"title":"帐号","field":"UserName"},{"title":"姓名","field":"UserTrueName"},{"dataKey":"gender","data":[],"title":"性别","field":"Gender","type":"select"}],[{"title":"不用","field":"DeptName"},{"dataKey":"tree_roles","data":[],"title":"角色","field":"Role_Id","type":"select"},{"title":"Token","field":"Token"}],[{"dataKey":"ut","data":[],"title":"類型","field":"AppType","type":"selectList"},{"dataKey":"isphone","data":[],"title":"手机用戶","field":"IsRegregisterPhone","type":"select"},{"title":"手机号","field":"PhoneNo"}],[{"dataKey":"enable","data":[],"title":"是否可用","field":"Enable","type":"select"},{"title":"地址","field":"Address"},{"title":"Email","field":"Email"}],[{"title":"注册時间","field":"CreateDate","type":"datetime"},{"title":"最后登陆時间","field":"LastLoginDate","type":"datetime"}]]);
            const columns = ref([{field:'User_Id',title:'User_Id',type:'int',width:90,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'AppType',title:'類型',type:'int',bind:{ key:'ut',data:[]},width:150,hidden:true,align:'left'},
                       {field:'DeptIds',title:'組织构架',type:'string',bind:{ key:'組织机构',data:[]},width:140,hidden:true,align:'left'},
                       {field:'CreateDate',title:'注册時间',type:'datetime',width:150,readonly:true,align:'left',sort:true},
                       {field:'IsRegregisterPhone',title:'手机用戶',type:'int',bind:{ key:'isphone',data:[]},width:120,hidden:true,align:'left'},
                       ...
                       {field:'ModifyDate',title:'修改時间',type:'datetime',width:90,hidden:true,readonly:true,align:'left',sort:true},
                       ...
                       {field:'AuditDate',title:'审核時间',type:'datetime',width:150,hidden:true,align:'left',sort:true},
                       {field:'LastLoginDate',title:'最后登陆時间',type:'datetime',width:150,hidden:true,align:'left',sort:true},
                       {field:'LastModifyPwdDate',title:'最后密码修改時间',type:'datetime',width:150,hidden:true,align:'left',sort:true},
