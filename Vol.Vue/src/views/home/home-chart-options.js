var chart1 = {
    ...
    legend: {
        top: 'bottom',
        icon: "circle",   //  这个字段控制形状  類型包括 circle，rect ，roundRect，triangle，diamond，pin，arrow，none
        itemWidth: 10,  // 設置宽度
        itemHeight: 10, // 設置高度
        itemGap: 7,// 設置间距
        padding: [0, 0, 15, 0] //圖例距离
    },
    series: [
        {
            name: '框架',
...
var chart2 = {
    ...
    tooltip: {
        ...
        axisPointer: {            // 坐标轴指示器，坐标轴触发有效
            type: 'shadow'        // 默認為直线，可选為：'line' | 'shadow'
        }
    },
    legend: {
        data: ['2.0下载量', '3.0下载量'],
