  ...
  data() {
    return {
      ...
      list: [
        ...
        { desc: '框架使用的Element Plus組件，移除了Iview組件的依赖' },
        { desc: '框架内部組件全部重新优化,相比2.x版本首屏大小减少60%' },
        { desc: '框架Vue2版本会继续维护,并與Vue3版本同步更新,請放心使用' },
        ...
        {
          desc: '自定义部分既可以使用vue3语法與可以使用vue3语法'
        }
        //(框架内部組件vue2/3语法都在使用),你也可以使用vue3语法
      ],
      grid: [
        {
          name: '用戶管理',
          desc: '系統用戶管理,注册用戶3000000人。',
          icon: 'el-icon-user'
        },
        {
          name: '站内消息',
