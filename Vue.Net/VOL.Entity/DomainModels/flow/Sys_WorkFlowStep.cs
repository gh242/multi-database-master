...
namespace VOL.Entity.DomainModels
{
    ...
    public partial class Sys_WorkFlowStep: SysEntity
    {
       ...
       /// <summary>
       ///节点類型(1=按用戶审批,2=按角色审批)
       /// </summary>
       [Display(Name ="节点類型(1=按用戶审批,2=按角色审批)")]
       [Column(TypeName="int")]
       [Editable(true)]
       ...
       /// <summary>
       ///审核未通過(返回上一节点,流程重新开始,流程結束)
       /// </summary>
       [Display(Name ="审核未通過(返回上一节点,流程重新开始,流程結束)")]
       [Column(TypeName="int")]
       [Editable(true)]
       public int? AuditRefuse { get; set; }

       /// <summary>
       ///驳回(返回上一节点,流程重新开始,流程結束)
       /// </summary>
       [Display(Name ="驳回(返回上一节点,流程重新开始,流程結束)")]
       [Column(TypeName="int")]
       [Editable(true)]
       ...
       ///节点屬性(start、node、end))
       /// </summary>
       [Display(Name ="节点屬性(start、node、end))")]
       [MaxLength(50)]
