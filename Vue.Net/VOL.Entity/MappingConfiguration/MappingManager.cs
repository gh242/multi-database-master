...
//        //默認字符串长度，而不是nvarchar(max).
//        //為什么要insert(0,obj),则是因為这个默認规则要最优先處理，如果后续有规则的话就直接覆盖了。
//        //propertyBuilder.HasMaxLength(32, ConfigurationSource.Convention);
//        //理论上我指定了规则的级别為.Convention，應该和顺序就没有关系了。but，还没有完成测试，所以我也不知道
