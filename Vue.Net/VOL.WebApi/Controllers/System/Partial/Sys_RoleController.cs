...
namespace VOL.System.Controllers
{
    ...
    {
        private readonly ISys_RoleService _service;//訪問業務代码
        ...
        {
            //獲取根节点数据(对應Sys_Role1.js中searchBefore方法)
        ...
        {
            //页面加载根节点数据条件x => x.ParentId == 0,自己根据需要設置
