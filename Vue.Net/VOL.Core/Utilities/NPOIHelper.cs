...
//        /// 默認第一行為标头
//        /// </summary>
//        /// <param name="strFileName">excel 文档路徑</param>
//        /// <returns></returns>
...
//        /// <param name="strHeaderText">表头文本 空值未不要表头标题(多个表对應多个表头以英文逗号(,)分开，个数應與表相同)</param>
//        /// <returns></returns>
...
//                            headerRow.GetCell(column.Ordinal).CellStyle = headStyle;
//                            //設置列宽
//                            // sheet.SetColumnWidth(column.Ordinal, (arrColWidth[column.Ordinal] + 1) * 256); // 設置設置列宽 太长会報错 修改2014 年9月22日
