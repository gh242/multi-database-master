...
/// 这个是用VS2010写的，如果用VS2005，請去掉System.Linq和System.Xml.Linq的引用
/// 可以將此文件直接编译成dll，今后程序只需要引用该dll后开头添加using XmlLibrary;即可。
namespace Rattan.Basic.Utility
{
	...
	public class XMLHelper
	{
		...
		/// <summary>
		/// 创建一个XML文档，成功创建后操作路徑將直接指向该文件
		/// </summary>
		/// <param name="fileName">文件物理路徑名</param>
		/// <param name="rootNode">根結点名称</param>
		...
		/// <param name="attributeName">新屬性名称</param>
		...
		/// <param name="node">节点对象</param>
		/// <param name="namespaceOfPrefix">该节点的命名空间URI</param>
		/// <param name="attributeParameters">节点屬性参数</param>
		...
		/// </summary>
		/// <param name="xmlParameter">XML参数</param>
		/// <param name="attributeParameters">屬性参数</param>
