...
namespace VOL.Core.CacheManager
{
    public class MemoryCacheService : ICacheService
    {
        ...
        /// <param name="key">緩存Key</param>
        /// <param name="value">緩存Value</param>
        /// <param name="expiresSliding">滑动過期时长（如果在過期时间内有操作，则以當前时间点延长過期时间）</param>
        /// <param name="expiressAbsoulte">绝对過期时长</param>
        /// <returns></returns>
        ...
        /// <param name="isSliding">是否滑动過期（如果在過期时间内有操作，则以當前时间点延长過期时间）</param>
        /// <returns></returns>
