...
namespace VOL.Core.BaseProvider
{
    public interface IRepository<TEntity> where TEntity : BaseEntity
    {
        ...
        /// <param name="sources">要查询的多个条件的数据源</param>
        /// <param name="predicate">生成的查询条件</param>
        /// <param name="selector">自定义返回結果</param>
        /// <returns></returns>
        ...
        /// <param name="predicate"></param>
        /// <param name="orderBy">
        /// 通過多个字段排序Expression<Func<TEntity, Dictionary<object, bool>>>
        ///  orderBy = x => new Dictionary<object, bool>() {
        ///          { x.BalconyName,QueryOrderBy.Asc},
        ///          { x.TranCorpCode1,QueryOrderBy.Desc}
        ///         };
        ...
        /// <param name="delList">是否將子表的数据也删除</param>
        /// <returns></returns>
       ...
       void BulkInsert(IEnumerable<TEntity> entities, bool setOutputIdentity = false);
        ...
        /// FromSqlInterpolated内部處理sql注入的問题，直接在{xx}写对應的值即可
        ...
        /// <summary>
        /// 取消上下文跟踪(2021.08.22)
        /// 更新報错时，請調用此方法：The instance of entity type 'XXX' cannot be tracked because another instance with the same key value for {'XX'} is already being tracked.
        /// </summary>
        /// <param name="entity"></param>
