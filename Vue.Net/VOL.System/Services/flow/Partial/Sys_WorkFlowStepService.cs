/*
 *所有关于Sys_WorkFlowStep類的業務代码應在此處编写
...
*Sys_WorkFlowStepService对增、删、改查、导入、导出、审核業務代码擴展参照ServiceFunFilter
*/
...
namespace VOL.System.Services
{
    public partial class Sys_WorkFlowStepService
    {
        ...
        private readonly ISys_WorkFlowStepRepository _repository;//訪問數據庫
