/*
 *所有关于Sys_WorkFlowTableStep類的業務代码應在此處编写
...
*Sys_WorkFlowTableStepService对增、删、改查、导入、导出、审核業務代码擴展参照ServiceFunFilter
*/
...
namespace VOL.System.Services
{
    public partial class Sys_WorkFlowTableStepService
    {
        ...
        private readonly ISys_WorkFlowTableStepRepository _repository;//訪問數據庫
