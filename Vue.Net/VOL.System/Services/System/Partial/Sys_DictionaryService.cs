    ...
    public partial class Sys_DictionaryService
    {
        ...
        public object GetVueDictionary(string[] dicNos)
        {
            ...
            object GetSourceData(string dicNo, string dbSql, object data,string dbServer)
            {
                ...
                return DBServerProvider.GetSqlDapperWithName(DBServerProvider.GetContextName(dbServer))
               .QueryList<object>(dbSql, null);
            }
        ...
        /// <summary>
        /// 表单設置為远程查询，重置或第一次添加表单时，獲取字典的key、value
        /// </summary>
        /// <param name="dicNo"></param>
        /// <param name="value"></param>
        /// <returns></returns>
